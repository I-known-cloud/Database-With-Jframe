    ...
    public Vector<Vector<Object>> Using_1() {
        ...
        try{
            ...
            while (resultSet1.next()){
                ...
                String s2 = resultSet1.getString("cust_name");
                String s3 = resultSet1.getString("cust_age");
                String s4 = resultSet1.getString("cust_isVIP");
                String s5 = resultSet1.getString("cust_sex");
